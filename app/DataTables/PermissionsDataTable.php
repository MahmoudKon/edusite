...
class PermissionsDataTable extends DataTable
{
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->pageLength(5)
            ->buttons([
                Button::make()->text('<i class="fa fa-plus"></i>')->addClass('btn btn-outline-info datatables-create-button show-modal-form')->titleAttr('Create New Permission (c)')->key('c'),
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id')->width(50)->addClass('text-center'),
            Column::make('name')->title('Permission')->width(100),
            Column::make('roles')->title('Roles')->width(150),
